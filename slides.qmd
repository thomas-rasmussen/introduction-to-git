...
Version control systems (VCS) records changes to files over time

Facilitates reverting back and forth between different versions of files.
...
Git is a so-called distributed version control system (DVCS)

Originally developed by Linus Torvald, the creator of Linux, to replace the DVCS BitKeeper
that was used to manage developed of the Linux kernal software project.
